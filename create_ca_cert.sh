...
EOF
    ...
    [[ "a${DEBUG}" == "atrue" ]] && logInfo "show the CA cert details"
    [[ "a${DEBUG}" == "atrue" ]] && openssl x509 -noout -text -in ${CA_CRT_FILE}
...
[[ "a${DEBUG}" == "atrue" ]] && logInfo "Show the singing request, to make sure extensions are there"
[[ "a${DEBUG}" == "atrue" ]] && openssl req -in ia.csr -noout -text
...
[[ "a${DEBUG}" == "atrue" ]] && logInfo "show the IA cert details"
[[ "a${DEBUG}" == "atrue" ]] && openssl x509 -noout -text -in ia.crt
...
[[ "a${DEBUG}" == "atrue" ]] && logInfo "Show the singing request, to make sure extensions are there"
[[ "a${DEBUG}" == "atrue" ]] && openssl req -in web.csr -noout -text
...
[[ "a${DEBUG}" == "atrue" ]] && logInfo "Show the final cert details"
[[ "a${DEBUG}" == "atrue" ]] && openssl x509 -noout -text -in web.crt
